...
- most simple way is to use gui. mention file size limitations (if applicable)
- use curl/wget in terminal to download files from internet. Useful for downloading files that the instructor can host online. Give example command
